...
export default [
  ...
  // Sluit de gegenereerde Svelte-bestanden uit
  { 
    ignorePatterns: [
      ".svelte-kit/*",
      "node_modules/*"
  ...
  // Voeg extra regels toe om specifieke lintingproblemen uit te schakelen
  {
    rules: {
      ...
      "@typescript-eslint/require-await": "off", // Schakel '@typescript-eslint/require-await' uit (als je deze rule hebt geconfigureerd)
