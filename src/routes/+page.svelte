      ...
      >
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
          {#each products as product}
            ...
            >
            <img 
            src={product.image ? `http://localhost:3010/products/product/image/${product.image}` : 'https://via.placeholder.com/300'} 
            alt={product.title} 
            class="h-60 w-full object-cover border-2 border-gray rounded-md" 
          />
